  ...
  config.module = {
    ...
    loaders: [
      ...
      // all css in src/style will be bundled in an external css file
      {
        ...
        loader: isTest ? 'null' : ExtractTextPlugin.extract('styles', 'css?sourceMap!postcss')
      },
...
      // Support for CSS Map as raw text
     /* { test: /\.css.map$/,   loader: 'raw-loader' },*/
      ...
      */
      // all css required in src/app files will be merged in js files
      // support for .scss files
      {test: /\.scss$/, exclude: helpers.root('node_modules'), loader: 'raw-loader!sass-loader' },
